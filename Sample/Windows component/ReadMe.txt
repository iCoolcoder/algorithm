========================================================================
    ACTIVE TEMPLATE LIBRARY : component Project Overview
========================================================================

AppWizard has created this component project for you to use as the starting point for
...
component.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (component.h)
        GUID definitions                                (component_i.c)
        A type library                                  (component.tlb)
        Marshaling code                                 (component_p.c and dlldata.c)

component.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in component.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named component.pch and a precompiled types file named StdAfx.obj.
...
componentps.vcproj
	...
	dlldata.c, component_i.c and component_p.c which are required
